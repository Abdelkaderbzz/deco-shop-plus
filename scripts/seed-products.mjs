...
const IMG = {
  ...
  closetOrganizerHero: '/assets/closet-organizer-primary.webp',
  closetOrganizerHold: '/assets/closet-organizer-hold.webp',
  closetOrganizerDetail: '/assets/closet-organizer-detail.webp',
  closetOrganizerLifestyle: '/assets/closet-organizer-lifestyle.webp',
  handbagOrganizerHero: '/assets/handbag-organizer-primary.webp',
  handbagOrganizerCloset: '/assets/handbag-organizer-closet.webp',
  handbagOrganizerLifestyle: '/assets/handbag-organizer-lifestyle.webp',
  handbagOrganizerFeatures: '/assets/handbag-organizer-features.webp',
  handbagOrganizerSolo: '/assets/handbag-organizer-solo.webp',
  doorDraftStopperHero: '/assets/door-draft-stopper-primary.webp',
  doorDraftStopperCut: '/assets/door-draft-stopper-cut.webp',
  doorDraftStopperInstall: '/assets/door-draft-stopper-install.webp',
  mattressProtectorHero: '/assets/mattress-protector-primary.webp',
  mattressProtectorCorner: '/assets/mattress-protector-corner.webp',
  mattressProtectorWaterproof: '/assets/mattress-protector-waterproof.webp',
}
...
const PRODUCTS = [
  ...
  },
  {
    ...
    promoLabel: 'Promotion',
    featured: true,
    related: ['rugCoverStorage', 'sr01', 'hc01', 'storageCubeLot5', 'garmentCover', 'closetOrganizer'],
  },
  {
    key: 'storageCubeLot5',
    ...
    promoLabel: 'Promotion',
    featured: true,
    related: ['storageBoxLot5', 'rugCoverStorage', 'sr01', 'hc01', 'garmentCover', 'closetOrganizer'],
  },
  {
    key: 'garmentCover',
  ...
  },
  {
    ...
    featured: true,
    related: ['garmentCover', 'dressCover120', 'suitCover150', 'rugCoverStorage', 'storageBoxLot5', 'closetOrganizer'],
  },
  {
    key: 'closetOrganizer',
    name: 'Organiseur de armoire',
    aliases: [
      'Organiseur d armoire',
      'Organiseur armoire kabba',
      'Separateur de vetements armoire',
      'Organiseur de dressing',
    ],
    brand: 'Deco Shop Plus',
    description:
      'Organiseur de armoire en tissu pour ranger vos vetements a la verticale : un compartiment, une piece. Plus d ordre, plus d espace dans votre dressing ou votre tiroir. Ideal pour jeans, t-shirts et habits plies. Couleur Gris. Vendue a l unite ou en pack.',
    price: '22.000',
    compareAtPrice: '22.000',
    category: 'rangement',
    image: IMG.closetOrganizerHero,
    images: [
      IMG.closetOrganizerHero,
      IMG.closetOrganizerHold,
      IMG.closetOrganizerDetail,
      IMG.closetOrganizerLifestyle,
    ],
    sizes: ['Unique'],
    colors: [{ name: 'Gris', hex: '#4b5563' }],
    bundles: [
      { name: '1 piece', units: 1, price: 22, popular: false },
      { name: '2 pieces', units: 2, price: 40, compareAtPrice: 44, popular: false },
      { name: '3 pieces', units: 3, price: 56, compareAtPrice: 66, popular: true },
    ],
    promoEnabled: true,
    promoLabel: 'Promotion',
    featured: true,
    related: ['storageBoxLot5', 'storageCubeLot5', 'garmentCover', 'rugCoverStorage', 'shoeCoverLot10', 'handbagOrganizer'],
  },
  {
    key: 'handbagOrganizer',
    name: 'Rangement pour les sacs à main',
    aliases: [
      'Rangement sacs a main',
      'Organiseur sacs a main',
      'Housse rangement sacs',
      'Porte sacs suspendu',
    ],
    brand: 'Deco Shop Plus',
    description:
      'Organiseur suspendu pour sacs a main : rangez vos sacs a la verticale dans le dressing. Poches transparentes et resistantes pour voir et proteger vos sacs. Crochet metallique pour penderie. Disponible en Gris et Noir. Vos sacs bien ranges, a portee de main.',
    price: '23.000',
    compareAtPrice: '28.000',
    category: 'rangement',
    image: IMG.handbagOrganizerHero,
    images: [
      IMG.handbagOrganizerHero,
      IMG.handbagOrganizerCloset,
      IMG.handbagOrganizerLifestyle,
      IMG.handbagOrganizerFeatures,
      IMG.handbagOrganizerSolo,
    ],
    sizes: ['Unique'],
    colors: [
      { name: 'Gris', hex: '#6b7280' },
    ...
    promoLabel: 'Promotion',
    featured: true,
    related: ['closetOrganizer', 'garmentCover', 'shoeCoverLot10', 'storageBoxLot5', 'storageCubeLot5', 'doorDraftStopper'],
  },
  {
    key: 'doorDraftStopper',
    name: 'Boudin de porte',
    aliases: [
      'Boudin de porte double',
      'Bas de porte anti courant d air',
      'Joint de porte mousse',
    ],
    brand: 'Deco Shop Plus',
    description:
    ...
    images: [
      ...
      IMG.doorDraftStopperInstall,
      IMG.doorDraftStopperCut,
    ],
    sizes: ['82 cm', '92 cm'],
    colors: [
      { name: 'Noir', hex: '#1f2937' },
    ...
    bundles: [
      { name: "L'unité", units: 1, price: 8, popular: false },
      { name: 'Pack de 3', units: 3, price: 19, compareAtPrice: 24, popular: true },
    ],
    promoEnabled: true,
    promoLabel: 'Promotion',
    featured: true,
    related: ['closetOrganizer', 'handbagOrganizer', 'rugCoverStorage', 'storageBoxLot5', 'garmentCover', 'mattressProtector'],
  },
  {
    key: 'mattressProtector',
    name: 'Protège-Matelas TNT Polypropylène – Fermeture Éclair',
    aliases: [
      'Protege matelas TNT',
      'Protege-matelas fermeture eclair',
      'Housse matelas polypropylene',
    ],
    brand: 'Deco Shop Plus',
    description:
    ...
    colors: [{ name: 'Blanc', hex: '#f5f5f5' }],
    featured: true,
    related: ['superFiestaPillow', 'headboardCushion', 'doorDraftStopper', 'closetOrganizer', 'handbagOrganizer'],
  },
]
